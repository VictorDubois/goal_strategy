...
public:
    ...
    /** @brief Fonction principale, applique l'algorithme de Dijkstra à toutes les étapes du
     * tableau, * en mettant à jour leur distance par rapport à l'étape courante *
     * @return 0 si tout va bien, -1 si l'étape en cours a changée (ce qui arrive pour décoincer le
     * robot) */
    int run();
     ...
     * proche à la plus éloignée de l'étape origine *
    ...
    /** @brief Met à jour les voisin de l'étape spécifiée. Cela correspond à mettre à jour leur
     * distance à l'origine si elle n'existait pas, ou bien si passer par cette étape est plus court
     * que le chemin envisagé jusqu'alors *
