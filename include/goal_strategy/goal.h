...
public:
    ...
    bool doneOrientingTo(Angle angle);
    bool arrivedThere();
...
private:
    void orientToAngle(Angle a_angle);
    int chooseAngle();
    void moveTowardGoal();
    ...
    void orientToAngleWithTimeout(Angle angleIfBlue, Angle angleIfNotBlue);
    bool isBlue();
    void chooseGear();
    void abortAction();
    void publishScore();
