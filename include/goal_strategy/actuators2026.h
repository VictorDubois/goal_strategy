#pragma once
#include "AX12.h"
#include "krabi_msgs/msg/actuators2026.hpp"
#include "pump.h"
...
{
private:
    rclcpp::Publisher<krabi_msgs::msg::Actuators2026>::SharedPtr m_pub;

    rclcpp::Node::SharedPtr m_node;
    krabi_msgs::msg::Actuators2026 m_message;
...
public:
    Actuators2026() {};
    Actuators2026(rclcpp::Node::SharedPtr a_node,
                  std::string a_name,
                  std::shared_ptr<Servomotor> m_servo_1,
                  std::shared_ptr<Servomotor> m_servo_2,
                  std::shared_ptr<Servomotor> m_servo_3,
