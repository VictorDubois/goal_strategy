...
CarreFouille::CarreFouille(Position goalPosition)
...
Etape::EtapeType CarreFouille::getType()
{
    return Etape::CARRE_FOUILLE;
}

int CarreFouille::update()
{
