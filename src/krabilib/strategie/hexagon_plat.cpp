...
Hexagon_plat::Hexagon_plat()
{
}

Hexagon_plat::Hexagon_plat(Position goalPosition, bool isGreen)
...
Etape::EtapeType Hexagon_plat::getType()
{
    return Etape::HEXAGON_PLAT;
}

int Hexagon_plat::update()
{
