...
PileGateau::PileGateau()
{
}

PileGateau::PileGateau(Position goalPosition, CoucheGateau type_couche)
  : MediumLevelAction(goalPosition)
  , type_couche(type_couche)
{
...
Etape::EtapeType PileGateau::getType()
{
    return Etape::PILE_GATEAU;
}

int PileGateau::update()
{
